  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h1 className="text-center text-3xl font-bold text-shop-text">Create your account</h1>
          <p className="mt-2 text-center text-shop-light-text">
        ...
        <div className="bg-white p-8 rounded-lg shadow">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-shop-text mb-1">
                Full Name
              </label>
              <Input
                id="name"
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-shop-text mb-1">
                Email address
              </label>
              <Input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-shop-text mb-1">
                Password
              </label>
              <Input
                id="password"
                ...
                disabled={isLoading}
              />
              <p className="mt-1 text-xs text-shop-light-text">
                Password must be at least 8 characters long
              </p>
            </div>
            
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-shop-text mb-1">
                Confirm Password
              </label>
              <Input
                id="confirmPassword"
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-shop-light-text">
                I agree to the{' '}
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-shop-light-text">Or register with</span>
              </div>
            </div>
