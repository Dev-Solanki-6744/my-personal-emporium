    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">YourStore</h3>
            <p className="text-gray-300 mb-4">
              Your one-stop shop for premium products with excellent customer service and fast delivery.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products?category=Fashion" className="text-gray-300 hover:text-white">Fashion</Link></li>
              <li><Link to="/products?category=Furniture" className="text-gray-300 hover:text-white">Furniture</Link></li>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <p className="text-center text-gray-400">
            &copy; {currentYear} YourStore. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
